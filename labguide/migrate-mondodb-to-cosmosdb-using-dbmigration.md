...
1. Provide name as `contentdb` **(1)** for **Database id**. Select **Provision throughput** and then select **Databse throughput** as **Manual** **(2)**,  provide the RU/s value to `400` **(3)** and click on **OK (4)**.
