...
$WebClient.DownloadFile("https://raw.githubusercontent.com/CloudLabsAI-Azure/Cloud-Native-Application/sumit-fix/labguide/labfiles/logontask01.ps1","C:\Packages\logontask.ps1")
