...
1. Navigate to **Metrics (1)** under **Monitoring** section. 

1. Select **Total Request Units (2)** as the Metric to view the total RU's consumed **graph (3)**.

    ![](media/E4T7S12-1411.png)
...
1. Notice that the graph now shows there was activity on the **Cosmos DB account** that exceeded the 400 RU/s limit that was previously set before Autoscale was turned on.
